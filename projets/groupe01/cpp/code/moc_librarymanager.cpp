...
struct qt_meta_stringdata_CLASSLibraryManagerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSLibraryManagerENDCLASS = QtMocHelpers::stringData(
    "LibraryManager"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLibraryManagerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject LibraryManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSLibraryManagerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSLibraryManagerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLibraryManagerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *LibraryManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSLibraryManagerENDCLASS.stringdata0))
